...
export const trackingResponseFixtures = {
  activeLoad: {
    ...
    events: [
      ...
      },
      {
        ...
        summary: 'ETA updated for delivery.',
      },
    ],
  },
  delayedLoad: {
  ...
  offlineNoUpdateLoad: {
    ...
    stops: [
      {
        ...
        appointmentWindow: {
          ...
          displayText: 'Jul 2, 6:00-8:00 AM EDT',
        },
        status: 'completed',
        arrivedAt: '2026-07-02T10:08:00Z',
        departedAt: '2026-07-02T10:44:00Z',
      },
      {
        id: 'stop-delivery',
        kind: 'delivery',
        ...
        appointmentWindow: {
          ...
          timezone: 'America/Detroit',
          displayText: 'Jul 2, 12:00-2:00 PM EDT',
        },
        status: 'pending',
        arrivedAt: null,
        departedAt: null,
    ...
    freshness: {
      status: 'offline_no_update',
      lastUpdatedAt: '2026-07-02T11:15:00Z',
      displayText: 'No update received for more than 2 hours',
    },
    events: [
      {
        id: 'event-departed-pickup',
        type: 'departed',
        stopId: 'stop-pickup',
        occurredAt: '2026-07-02T10:44:00Z',
        summary: 'Departed pickup.',
      },
    ],
  },
