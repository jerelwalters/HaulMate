...
enum NewLoadStrings: String, Localizable {
    ...
    case screenTitle
    case screenSubtitle
    case routeSectionTitle
    case brokerCustomerLabel
    case brokerCustomerPlaceholder
    case referenceNumberLabel
    case referenceNumberPlaceholder
    case pickupLabel
    case pickupPlaceholder
    case deliveryLabel
    case deliveryPlaceholder
    case rateConfirmationTitle
    case attachRateConfirmationButton
    case replaceRateConfirmationButton
    case noRateConfirmationAttached
    case attachmentImportFailure
    case attachmentKindPDF
    case attachmentKindImage
    case attachmentKindOther
    case revenueSectionTitle
    case lineHaulRateLabel
    case fuelSurchargeLabel
    case accessorialRevenueLabel
    case loadedMilesLabel
    case deadheadMilesLabel
    case estimatedTollsLabel
    case milesSuffix
    case feesSectionTitle
    case dispatchFeeLabel
    case factoringFeeLabel
    case otherFlatFeeLabel
    case overridesSectionTitle
    case overridesSectionSubtitle
    case fuelEconomyOverrideLabel
    case fuelPriceOverrideLabel
    case maintenanceOverrideLabel
    case monthlyFixedCostsOverrideLabel
    case workingMilesOverrideLabel
    case resultsSectionTitle
    case estimatedProfitLabel
    case grossRevenueLabel
    case operatingCostLabel
    case marginLabel
    case revenuePerLoadedMileLabel
    case revenuePerTotalMileLabel
    case loadedMilesSummaryLabel
    case deadheadMilesSummaryLabel
    case totalMilesSummaryLabel
    case missingInputsTitle
    case saveStatusLabel
    case evaluatingStatus
    case acceptedStatus
    case rejectedStatus
    case saveLoadButton
    case savedStatusFormat
    case brokerRequired
    case referenceRequired
    case pickupRequired
    case deliveryRequired
    case lineHaulInvalid
    case fuelSurchargeInvalid
    case accessorialRevenueInvalid
    case loadedMilesInvalid
    case deadheadMilesInvalid
    case totalMilesInvalid
